...
[![release](https://img.shields.io/github/v/release/nix-community/flake-du?logo=github&style=flat-square)](https://github.com/nix-community/flake-du/releases)
[![version](https://img.shields.io/crates/v/flake-du?logo=rust&style=flat-square)](https://crates.io/crates/flake-du)
[![deps](https://deps.rs/repo/github/nix-community/flake-du/status.svg?style=flat-square&compact=true)](https://deps.rs/repo/github/nix-community/flake-du)
[![license](https://img.shields.io/badge/license-MPL--2.0-blue?style=flat-square)](https://www.mozilla.org/en-US/MPL/2.0)
[![ci](https://img.shields.io/github/actions/workflow/status/nix-community/flake-du/ci.yml?label=ci&logo=github-actions&style=flat-square)](https://github.com/nix-community/flake-du/actions/workflows/ci.yml)
...
```bash
nix run github:nix-community/flake-du
```
